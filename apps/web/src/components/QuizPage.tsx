...
import { ArrowLeft, ArrowRight, Check, ChevronLeft, GitBranch, HardDrive, X } from 'lucide-react'
import type { Question } from '@tt16/core'
import { SOURCE_REPOSITORY_URL } from '../lib/project'
import { BrandMark } from './Illustrations'

type QuizPageProps = {
  question: Pick<Question, 'id' | 'kind' | 'prompt' | 'leftText' | 'rightText' | 'tag' | 'allowNA'>
  index: number
  total: number
  ...
  return (
    <main className="quiz-screen">
      <header className="quiz-header">
        ...
        <div className="quiz-save-state"><HardDrive size={15} /><span>{saveStateLabel}</span></div>
